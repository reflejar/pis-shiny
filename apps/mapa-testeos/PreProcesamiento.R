...
data=read.xlsx("C:/Users/simon/Downloads/BASE_ANALISIS_AMBIENTALESyORINA(2).xlsx",sheet = "ORINA",detectDates = TRUE)
...
for (i in 1:length(int)){
  ...
  if(length(filas)>0){
    tooltip=paste0("<center><b>Análisis de Orina Humana</b></center>","<hr style='margin: 0;'>")
    for(j in 1:length(filas)){
      if(j==1){
        tooltip=paste0(tooltip,"<center><b>Testeo</b> <b>",j,"</b>","</center>",
                       ...
                       "<i>","<center>","Solicitante:",data$SOLICITANTE[filas[j]],"</center>","</i>"
        )  
      }else{
        tooltip=paste0(tooltip,"<br>","<hr style='margin: 0 ;'>","<center><b>Testeo</b> <b>",j,"</b>","</center>",
                       "<b>Glifosato en Orina:</b>",data$GLIFOSATO.EN.ORINA[filas[j]],
                       " <br>","<b>Glifosato en Orina (AMPA):</b>",data$`GLIFOSATO.EN.ORINA.(AMPA)`[filas[j]],
                       " <br>","<b>Fecha de Testeo:</b>",data$FECHA[filas[j]],
                       " <br>","<center>","<b>Laboratorio:</b>",data$LABORATORIO[filas[j]],"</center>",
                       "<center>","<i>Solicitante:",data$SOLICITANTE[filas[j]],"</i>","</center>",
                       ' <extra></extra>')  
      }
...
for (i in 1:nrow(data)){
  ...
  tooltip=paste0("<center><b>Análisis de ",data$SECTOR.AMBIENTAL[i],"</b></center>","<hr style='margin: 0;'>",
  ...
  tooltip=paste0(tooltip,  " <br>","<center>","<b>Laboratorio:</b>",data$LABORATORIO[i],"</center>",
                 "<i>","<center>","Solicitante:",data$SOLICITANTE[i],"</center>","</i>")
